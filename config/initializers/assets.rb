...
Rails.application.config.assets.precompile += %w( admin_users.scss admin_users.js)
Rails.application.config.assets.precompile += %w( admin_items.scss admin_items.js)